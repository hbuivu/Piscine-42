...
int main(void) {
	...
	printf("STRSTR\n");
	printf("str = %s | to_find = %s \n",havstack,needle);
	printf("Calling: ret = strstr(str,to_find);\n");
    printf("ret = %s | str = %s | to_find = %s\n\n", strstr(havstack,needle),havstack,needle);

	printf("str = %s | to_find = %s \n",havstack,needle1);
	printf("Calling: ret = strstr(str,to_find);\n");
	printf("ret = %s | str = %s | to_find = %s\n\n", strstr(havstack,needle1),havstack,needle1);

	printf("str = %s | to_find = (empty)%s \n",havstack,empty);
	printf("Calling: ret = strstr(str,to_find);\n");
	printf("ret = %s | str = %s | to_find = (empty)%s\n\n", strstr(havstack,empty),havstack,empty);
